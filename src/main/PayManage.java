...
public class PayManage extends JFrame {
	private PayDAO dao;
	...
	public PayManage() {
		...
		manageStudent_Menu.setIcon(new ImageIcon(PayManage.class.getResource("/img/manage_menu.png")));
		...
		pay_menubar.setIcon(new ImageIcon(PayManage.class.getResource("/img/click_pay_menu.png")));
