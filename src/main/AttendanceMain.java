...
public class AttendanceMain extends JFrame implements MouseListener {
	...
	public AttendanceMain() {
		...
		table_stuList.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				AttendanceAlert a = new AttendanceAlert(num.getText(), name.getText(), age.getText());
				a.setVisible(true);
			}
		...
		attendanceMenu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AttendanceMain att = new AttendanceMain();
				dispose();
				att.setVisible(true);
			}
		});
		attendanceMenu.setIcon(new ImageIcon(AttendanceMain.class.getResource("/img/click_att_menu.png")));
		...
		manageStudent_Menu.setIcon(new ImageIcon(AttendanceMain.class.getResource("/img/manage_menu.png")));
		manageStudent_Menu.addActionListener(new ActionListener() {

			public void actionPerformed(ActionEvent e) {
				ManagementStudent manage = new ManagementStudent();
				dispose();
		...
		directly_att.setIcon(new ImageIcon(AttendanceMain.class.getResource("/img/directly_att.png")));
		...
		pay_menubar.setIcon(new ImageIcon(AttendanceMain.class.getResource("/img/pay_menu.png")));
		...
		statistics_menubar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				StatisticsManage sta = new StatisticsManage();
				dispose();
				sta.setVisible(true);
			}
		});
		statistics_menubar.setIcon(new ImageIcon(AttendanceMain.class.getResource("/img/statistics_menu.png")));
			...
			public void actionPerformed(ActionEvent e) {
				...
				table_stuList.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent e) {
						...
						AttendanceAlert a = new AttendanceAlert(num.getText(), name.getText(),
								age.getText());
						a.setVisible(true);
