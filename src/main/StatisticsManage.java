...
public class StatisticsManage extends JFrame {
	...
	public StatisticsManage() {
		...
		manageStudent_Menu.setIcon(new ImageIcon(StatisticsManage.class.getResource("/img/manage_menu.png")));
		...
		statistics_menubar.setIcon(new ImageIcon(StatisticsManage.class.getResource("/img/click_statistics.png")));
