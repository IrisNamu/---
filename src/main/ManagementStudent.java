...
public class ManagementStudent extends JFrame {
	...
	public ManagementStudent() {
		...
		attendanceMenu.setIcon(new ImageIcon(ManagementStudent.class.getResource("/img/att_menu.png")));
		...
		manageStudent_Menu.setIcon(new ImageIcon(ManagementStudent.class.getResource("/img/click_manage_.png")));
		manageStudent_Menu.addActionListener(new ActionListener() {

			public void actionPerformed(ActionEvent e) {
				dispose();
				ManagementStudent manage = new ManagementStudent(); // 홈화면 호출
		...
		revise.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				UpdateStuInfo up = new UpdateStuInfo(num.getText(), name.getText(), sex.getText(), age.getText(),
