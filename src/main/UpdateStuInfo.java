...
public class UpdateStuInfo extends JFrame {
	...
	public UpdateStuInfo(String num, String name, String sex, String age, String school, String grade, String class_,
		...
		s_save_btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (s_name.getText().equals(" * 이름을 입력해주세요.")) {
					...
					StudentVo vo = new StudentVo(HomeLogin.getUserID(), num, s_name.getText(), gender.getText(), age, s_school.getText(),
