...
public class attendance_Main extends JFrame {
	...
	public attendance_Main() {
		...
		statistics_Menu.setIcon(new ImageIcon(attendance_Main.class.getResource("/img/cal_menu.png")));
		statistics_Menu.setBackground(new Color(19, 25, 53));
		statistics_Menu.setBounds(170, 0, 87, 64);
		...
		spinner_date.setBounds(91, 53, 256, 22);
		chooseDateCheck.add(spinner_date);
