...
public class zzpaste extends JFrame {
	 ...
	 */
	public zzpaste() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(zzpaste.class.getResource("/img/\uC571\uC544\uC774\uCF58.png")));
		...
		attendanceMenu.setIcon(new ImageIcon(zzpaste.class.getResource("/img/\uCD9C\uC11D\uC120\uD0DD.png")));

		JButton manageStudent_Menu = new JButton("");
		manageStudent_Menu.setIcon(new ImageIcon(zzpaste.class.getResource("/img/\uC6D0\uC0DD\uAD00\uB9AC\uBA54\uB274\uBC14.png")));
		...
		calendar_Menu.setIcon(new ImageIcon(zzpaste.class.getResource("/img/\uB2EC\uB825\uBA54\uB274\uBC14.png")));
		...
		statistics_Menu.setIcon(new ImageIcon(zzpaste.class.getResource("/img/\uD1B5\uACC4\uBA54\uB274\uBC14.png")));
		...
		birthday_Menu.setIcon(new ImageIcon(zzpaste.class.getResource("/img/\uC0DD\uC77C\uBA54\uB274\uBC14.png")));
